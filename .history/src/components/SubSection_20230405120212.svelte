...
<div class="bg-white shadow-md rounded-lg p-6">
  ...
  <p class="text-gray-700 mb-6">
    Stock up on nutritious and organic groceries to fuel your healthy lifestyle.
    Choose from a variety of products, including grains, snacks, and beverages,
    carefully selected for their quality and taste.
  </p>
  <a
    href="/groceries"
